  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-3 sm:px-6 md:px-10 lg:px-[120px]">
      ...
      <div className="flex flex-col items-center gap-2.5 px-2.5 py-2.5 mb-6 md:mb-10">
        <h2 className="text-xl md:text-2xl font-semibold text-[#141416] text-center">2026 Jewellery Essentials</h2>
      </div>

      {/* Essentials Grid - 1 col mobile, 2 tablet, 3 desktop */}
        ...
        {data.map((item) => (
          ...
          >
            ...
            <div className="absolute bottom-3 md:bottom-[15px] left-1/2 transform -translate-x-1/2">
              <span className="text-sm md:text-base font-bold text-white">{item.name}</span>
            </div>
          </div>
        ))}
      </div>
